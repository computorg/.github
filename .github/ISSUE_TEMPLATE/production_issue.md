...
- [ ] the EiC set the metadata appropriately (status: published, repos, doi, google-scholar: true; date: publication date under format MM-DD-YYYY; date-modified: last-modified.)
...
- [ ] the EiC set the DOI on DataCite as "findable"
